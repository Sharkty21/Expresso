...
db.serialize(() => {
    ...
    db.run('CREATE TABLE IF NOT EXISTS MenuItem (id INTEGER PRIMARY KEY, name TEXT NOT NULL, description TEXT NOT NULL, inventory INTEGER NOT NULL, price INTEGER NOT NULL, menu_id INTEGER NOT NULL, FOREIGN KEY(menu_id) REFERENCES MenuItem(id))');
});